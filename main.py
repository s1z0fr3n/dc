...
def button():
	BUTTON=[[InlineKeyboardButton(text="??????? Sahibim ",url="t.me/ekiplider")]]
	BUTTON+=[[InlineKeyboardButton(text="?? Open Source ??",url="https://t.me/yesilyolsohbet")]]
